...
export const DEFAULT_FILTER = { sender: null, types: null, windowMs: 1800000, directOnly: false, unnamed: false }
...
export function makeFilter(opts) {
  const { sender, types, windowMs, directOnly, unnamed, ignore } = opts
