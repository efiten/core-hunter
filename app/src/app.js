...
function updateSoundIcon() {
  ...
  // offIndex (#373, #620): 'off' is index 0 of the cycle but it is neither a
  // progress position nor a segment, so the ring is empty there and rx-tx is
  // half of it. Node positions passes it too -- the compass and view FABs have
  // on states at index 0.
